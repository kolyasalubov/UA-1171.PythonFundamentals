from area_calculation import comp_area_of_rectangle
from area_calculation import comp_area_of_triangle
from area_calculation import comp_area_of_circle
...
match command:
    case 1:
        ...
        rect_area = comp_area_of_rectangle(rect_length, rect_breadth)
    ...
    case 2:
        ...
        triangle_area = comp_area_of_triangle(triangle_base, triangle_height)
    ...
    case 3:
        ...
        circle_area = comp_area_of_circle(circle_radius)
