...
COORD_X=WIDTH_DISPLAY/2
COORD_Y=HEIGHT_DISPLAY/2
WIDTH_RECTANGLE=40
HEIGHT_RECTANGLE=60
DELTA_STEP=5
...
while run:
    ...
    if keys[pygame.K_RIGHT] and COORD_X < WIDTH_DISPLAY - WIDTH_RECTANGLE - 5:
        COORD_X = COORD_X+DELTA_STEP
    if keys[pygame.K_UP] and COORD_Y > DELTA_STEP:
        COORD_Y = COORD_Y-DELTA_STEP
    if keys[pygame.K_DOWN] and COORD_Y < HEIGHT_DISPLAY - HEIGHT_RECTANGLE - 5: 
        COORD_Y = COORD_Y+DELTA_STEP
